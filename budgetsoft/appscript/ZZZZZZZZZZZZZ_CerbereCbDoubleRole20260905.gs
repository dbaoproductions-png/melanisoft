 ...
 */
const CERBERE_CB_DOUBLE_ROLE_VERSION='2026-09-05.7';
...
function calculerReportCbCycleSuivant20260905_(base){
  ...
  const aCb=jour(d11),z1=jour(d12),tn=jour(now);
  /* Doctrine : toute CB achetée pendant C1 sert immédiatement au pilotage des
   * molettes de C1 par date d'achat ET réduit le global de C2, où le débit
   * différé sera supporté. Cette seconde lecture ne touche pas les molettes C2. */
  const debutCb=d11,impactCycle2=d21,a2=jour(d21),z2=jour(d22);
...
function chargerCerbereCockpit20260902(){
  const executer=function(){
    ...
    base.cockpit20260902={version:'2026-09-05.cb-double-role-7',appreciation:appreciation,performance:perf,doctrine:'Cockpit C1/C2 : CB imputée aux lignes par date achat dans C1 et au global de C2 sans toucher aux molettes C2.'};
  ...
  return typeof avecContexteLectureBudgetSoft20260827_==='function'?avecContexteLectureBudgetSoft20260827_('cerbere-cockpit-cb-double-role-20260905-v7',executer):executer();
}
