...
function dateAchatCbDoubleRole20260905_(o){
   ...
   * d'achat, même quand date_comptable correspond à une autre date d'import. */
...
function estAchatCbDoubleRole20260905_(o){
  ...
  /* Les imports Hello bank conservent parfois seulement le numéro masqué de
   * carte, sans les champs carte_fin/date_achat. */
