...
function composerDashboardSyntheseBudgetSoft20260907_(ctx){
  ...
  return{ok:true,version:BUDGETSOFT_DASHBOARD_SYNTHESE_VERSION,versionCorrection:'3.2',sourceBudgetSoft:'composition_snapshot',doctrine:'Dashboard de synthèse : aucune vérité métier recalculée quand un propriétaire BudgetSoft/Cerbère existe ; une projection indisponible est affichée comme telle plutôt qu’inventée. Historique : solde J1 = solde d’ouverture avant les opérations du premier jour.',courtTerme:courant,cycleSuivant:suivant,cyclePrecedent:precedent,provenance:{solde:'tresorerieComptable',previsionsCourant:'projectionEtendue',previsionsCycleSuivant:'Cerbère/Cerbère Express uniquement ; soldes masqués tant que la trésorerie future complète n’a pas de propriétaire fiable',pilotable:'cerbereExpress',cbDifferees:'cerbereExpress',historique:'Operations canoniques + solde canonique ; frontière J1 en ouverture'}};
}
