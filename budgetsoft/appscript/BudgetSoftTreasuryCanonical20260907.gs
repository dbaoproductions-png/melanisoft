...
function sousVueTrajectoireTresorerieCanoniqueBudgetSoft20260910_(trajectoire,dateCible){
  ...
  copie.lignes=(trajectoire.lignes||[]).filter(function(l){const d=new Date(l&&l.date);if(isNaN(d.getTime()))return false;return Utilities.formatDate(d,Session.getScriptTimeZone(),'yyyy-MM-dd')<=cible;});
