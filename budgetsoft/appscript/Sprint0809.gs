const BUDGETSOFT_SPRINT_VERSION = '0.9';
...
function chargerConfigurationBudgetaire() {
  ...
  return {
    ...
    jourDebutMois: bornerJourBudgetaire_(dictionnaire.jour_debut_mois || 28),
    jourSalaire: bornerJourBudgetaire_(dictionnaire.jour_salaire || dictionnaire.jour_debut_mois || 28),
    devise: String(dictionnaire.devise || 'EUR'),
    periodeCourante: calculerPeriodeBudgetaire_(new Date(), dictionnaire.jour_debut_mois || 28)
  };
}
