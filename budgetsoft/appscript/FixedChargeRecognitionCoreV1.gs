const FIXED_CHARGE_RECOGNITION_CORE_VERSION='1.0.0';
...
function reconnaitreChargeFixeCommune_(operation,charges,rapprochements){
  ...
  // Garde-fou anti-régression : même matcher que l'import PDF.
  ...
  // Même évaluateur que l'écran Operations, seulement en secours diagnostic.
