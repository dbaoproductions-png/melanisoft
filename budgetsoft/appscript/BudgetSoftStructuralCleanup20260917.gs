const BUDGETSOFT_STRUCTURAL_CLEANUP_20260917_VERSION='2026-09-19.29';
...
function auditerNettoyageStructurelBudgetSoft20260917(){
  ...
  const controles=[
    ...
    {code:'CERBERE_UI_TRESORERIE_CANONIQUE_HORS_FICHIER_Z',ok:typeof chargerTrajectoireBanqueCerbereRapide20260903==='function'&&typeof auditerTrajectoireCerbereUiCanonique20260913==='function'&&String(chargerTrajectoireBanqueCerbereRapide20260903).indexOf('chargerTresorerieUnifieeBudgetSoft20260907')>=0,detail:'adaptateur UI Cerbère -> trésorerie unifiée promu hors Z sans calcul local'},
