const BUDGETSOFT_STRUCTURAL_CLEANUP_20260917_VERSION='2026-09-19.30';
...
function auditerNettoyageStructurelBudgetSoft20260917(){
  ...
  const controles=[
    ...
    {code:'CERBERE_ALIAS_HISTORIQUE_HORS_FICHIER_Z',ok:typeof chargerCerbereCockpit20260902==='function'&&String(chargerCerbereCockpit20260902).indexOf('chargerCerbereCockpitCanonique20260914')>=0&&typeof auditerEntreePubliqueCerbereSnapshotFirst20260906==='function',detail:'alias historique Cerbère promu hors Z et délégué explicitement vers endpoint canonique'},
    {code:'CERBERE_PLUXEE_HORS_FICHIER_Z',ok:typeof chargerPluxeeCerbere20260827==='function'&&typeof sauvegarderAllocationPluxeeCerbere20260827==='function'&&typeof reinitialiserAllocationPluxeeCerbere20260827==='function'&&typeof auditerPluxeeCerbere20260827==='function',detail:'module Cerbère/Pluxee 20260827 promu hors Z sans collision'},
