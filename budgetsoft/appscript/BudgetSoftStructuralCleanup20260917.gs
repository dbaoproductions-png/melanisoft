const BUDGETSOFT_STRUCTURAL_CLEANUP_20260917_VERSION='2026-09-19.29.1';
...
function auditerNettoyageStructurelBudgetSoft20260917(){
  ...
  const controles=[
    ...
    {code:'CERBERE_UI_TRESORERIE_CANONIQUE_HORS_FICHIER_Z',ok:typeof chargerTrajectoireBanqueCerbereRapide20260903==='function'&&typeof auditerTrajectoireCerbereUiCanonique20260913==='function'&&String(chargerTrajectoireBanqueCerbereRapide20260903).indexOf('chargerTresorerieUnifieeBudgetSoft20260907')>=0,detail:(function(){const f=typeof chargerTrajectoireBanqueCerbereRapide20260903==='function'?String(chargerTrajectoireBanqueCerbereRapide20260903):'';return 'endpoint='+String(typeof chargerTrajectoireBanqueCerbereRapide20260903==='function')+' ; audit='+String(typeof auditerTrajectoireCerbereUiCanonique20260913==='function')+' ; délègueUnifiée='+String(f.indexOf('chargerTresorerieUnifieeBudgetSoft20260907')>=0)+' ; source='+f.slice(0,260).replace(/\s+/g,' ');})()},
