const BUDGETSOFT_STRUCTURAL_CLEANUP_20260917_VERSION='2026-09-18.18';
...
function auditerNettoyageStructurelBudgetSoft20260917(){
  ...
  const controles=[
    ...
    {code:'EVENEMENTS_EFFECTIFS_DUEFIX_DANS_MOTEUR_20260831',ok:typeof completerEvenementsEffectifsTresorerie20260831_==='function'&&String(completerEvenementsEffectifsTresorerie20260831_).indexOf('statutRecetteEncoreDueProjection20260912_')>=0,detail:'DueFix événements intégré au propriétaire TreasuryForecastCorrections20260831'},
