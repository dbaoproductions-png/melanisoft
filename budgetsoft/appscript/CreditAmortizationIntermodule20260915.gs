const CREDIT_AMORTIZATION_INTERMODULE_20260915_VERSION='2026-09-15.5';
...
function calculerAmortissementCredit20260915_(credit,operation){
  const capital=Math.max(0,Number(credit&&credit.capital_restant||0)),montant=Math.abs(Number(operation&&operation.montant||0)),explicite=ventilationExpliciteCredit20260915_(credit,montant,operation);
